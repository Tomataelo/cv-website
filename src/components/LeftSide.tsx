        ...
        <div className="flex flex-col justify-between p-8 w-70% max-w-[70%] mt-8">
            <div className="mb-8">
                ...
                <p className="text-lg text-[rgb(130,146,170)] mt-4">
                    Jestem ambitnym programistą, który lubi poszerzać swoje horyzonty. Moim "konikiem" jest backend, ale frontend nie jest mi straszny. Więcej w zakładce "O mnie".                </p>
            </div>
